import { x as push, V as copy_payload, W as assign_payload, z as pop, Z as sanitize_slots, E as sanitize_props, G as fallback, Y as attr, S as attr_class, M as clsx, N as slot, J as bind_props, F as rest_props, X as stringify, I as spread_props, Q as escape_html } from './index-_YnrmJpM.js';
...
import { S as Select } from './Select-D2oYF2zT.js';
...
function Modal($$payload, $$props) {
  ...
  if (open) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div${attr_class(clsx(backdropCls))}></div>  <div${attr_class(clsx(dialogCls))} tabindex="-1" aria-modal="true" role="dialog"><div${attr_class(`flex relative ${stringify(sizes[size])} w-full max-h-screen`)}>`;
...
//# sourceMappingURL=_page.svelte-Cg02cc_o.js.map
