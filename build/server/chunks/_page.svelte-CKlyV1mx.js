...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="flex flex-col items-center w-full"><h1 class="text-center text-primary-700 m-0.5">Vím o chybě v řazení žebříčků, aktuálně pracuji na její nápravě. Berte, prosím, zde generované žebříčky za předběžné. Při vyhlášení výsledků budou kontrolovány a zpracovávány ručně.</h1> <!--[-->`;
  for (let $$index_2 = 0, $$length = each_array.length; $$index_2 < $$length; $$index_2++) {
    let board = each_array[$$index_2];
    $$payload.out += `<h2 class="text-2xl">${escape_html(levels[board.level])} - ${escape_html(pohlavi[board.sex])}</h2> <div class="flex-col md:max-w-3xl max-w-full overflow-x-scroll">`;
    Table($$payload, {
      children: ($$payload2) => {
        TableHead($$payload2, {
          children: ($$payload3) => {
...
//# sourceMappingURL=_page.svelte-CKlyV1mx.js.map
