...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div class="flex flex-col w-full justify-center"><div class="flex flex-col items-center"><h1 class="text-3xl font-bold">Uživatelé</h1> `;
  Table($$payload, {
    children: ($$payload2) => {
      TableHead($$payload2, {
        children: ($$payload3) => {
...
//# sourceMappingURL=_page.svelte-D8rm_esB.js.map
